<?php
//echo "jugllu";
include 'addTagStub.php';
include 'addTagAPI.php';

//include '../Login/login.php';
class addTagActivity
{
...
?>
	...
	private function verifyForm(){
		...
		if((!isset($this->albumName) || $this->albumName == '') || (!isset($this->pictureName) || $this->pictureName == '') || (!isset($this->userName) || $this->userName == '') || (!isset($this->tagName) || $this->tagName == '')){
			//something's missing
			$this->PrintError(0);
